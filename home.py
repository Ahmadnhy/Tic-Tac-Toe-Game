...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(content_frame, text="Tic Tac Toe", font=("Poppins", 28, "bold"),
                 bg="#F0F0F0", fg="#222").pack(pady=20)

        tk.Label(content_frame, text="Masukkan nama pemain", font=("Poppins", 12),
        ...
        tk.Button(content_frame, text="Mulai Permainan 🎮", font=("Poppins", 12, "bold"),
