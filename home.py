...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Tic Tac Toe", font=("Poppins", 28, "bold"),
                 bg="#F0F0F0", fg="#222").pack(pady=20)

        tk.Label(self, text="Masukkan nama pemain", font=("Poppins", 12),
                 bg="#F0F0F0", fg="#333").pack(pady=10)

        frame_inputs = tk.Frame(self, bg="#F0F0F0")
        frame_inputs.pack()

        tk.Label(frame_inputs, text="Player 1 (X):", font=("Poppins", 11),
                 bg="#F0F0F0", fg="#333").grid(row=0, column=0, pady=5, sticky="e")
        self.entry_player1 = tk.Entry(frame_inputs, font=("Poppins", 11), width=18)
        self.entry_player1.grid(row=0, column=1, pady=5, padx=5)

        tk.Label(frame_inputs, text="Player 2 (O):", font=("Poppins", 11),
                 bg="#F0F0F0", fg="#333").grid(row=1, column=0, pady=5, sticky="e")
        self.entry_player2 = tk.Entry(frame_inputs, font=("Poppins", 11), width=18)
        self.entry_player2.grid(row=1, column=1, pady=5, padx=5)

        tk.Button(self, text="Mulai Permainan 🎮", font=("Poppins", 12, "bold"),
                  bg="#4DA8DA", fg="white", width=20, relief="flat",
